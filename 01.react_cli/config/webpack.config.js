...
// 是否生成map文件
// 在package.json文件中，通过cross-env修改（cross-env GENERATE_SOURCEMAP=false）
...
module.exports = function (webpackEnv) {
    ...
    return {
        ...
        optimization: {
            ...
            // 代码分割打包： node_modules 代码超过指定大小时，会单独打包成一个文件。如果存在import语法，懒加载，也会打包成单独文件
            splitChunks: {
                chunks: 'all',
        ...
        plugins: [
            ...
            // 监视node_modules，一旦发生变化（比如：丢失模块），可以重启devServer
            isEnvDevelopment &&
